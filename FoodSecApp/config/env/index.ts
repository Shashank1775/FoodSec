...
export const OCR_CONFIG = {
  apiKey: env('EXPO_PUBLIC_OCR_SPACE_API_KEY') ?? 'helloworld',
...
export const AZURE_OPENAI_CONFIG = {
  endpoint: env('EXPO_PUBLIC_AZURE_OPENAI_ENDPOINT'),
  apiKey: env('EXPO_PUBLIC_AZURE_OPENAI_KEY'),
  deployment: env('EXPO_PUBLIC_AZURE_OPENAI_DEPLOYMENT'),
